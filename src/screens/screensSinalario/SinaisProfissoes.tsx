...
import { sinaisProfissoes } from '../components/Sinais';
...
export default function SinaisProfissoes({ navigation }: any) {
    ...
    const sinaisFiltrados = sinaisProfissoes.filter(({ title, subtitle }) => {
