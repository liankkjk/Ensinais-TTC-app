  ...
  const salvar = async () => {
    ...
    try {
      ...
      if (foto) {
        ...
        const fotoRef = ref(storage, `usuarios/${user.uid}/fotoPerfil.${fileExtension}`);
        
        const response = await fetch(foto);
        const blob = await response.blob();
  
        await uploadBytes(fotoRef, blob).then(async (uploadSnapshot) => {
